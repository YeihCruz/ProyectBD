...
public class ReinsurerProfileReportPanel extends JPanel {
    ...
    private final List<ReinsurerProfileReport> reinsurerProfileReports;

    public ReinsurerProfileReportPanel() {
        //Necesita Arreglo, Agregar Barra de Porcentaje
        reinsurerProfileReports = new ReportsServices().getReinsurerProfileReport(1);
